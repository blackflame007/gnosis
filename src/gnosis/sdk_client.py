...
class _TruncatingEmbedding(LiteLLMEmbeddingProvider):
    """LiteLLMEmbeddingProvider that pre-truncates texts to 30 000 chars.
    ...
    Inheriting from LiteLLMEmbeddingProvider ensures isinstance checks against
